...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser) -> None:
        parser.add_argument(
            'url', type=str, help='адрес файла данных в формате json')
    ...
    def handle(self, *args, **options) -> None:
        ...
        try:
            ...
            if created:
                save_place_image(place, image_urls, title)
                print(
                    f'Объект {title} с соответствующими изображениями создан')
        except KeyError:
...
def save_place_image(place, image_urls, title) -> None:
